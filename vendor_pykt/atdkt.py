# 来源：pykt-team/pykt-toolkit@2fc4d64880956f21155a238d0b0302ac42cb5196 pykt/models/atdkt.py
# PyPI 上的 pykt-toolkit 0.0.38 没有 AT-DKT，所以原样复制过来；唯一改动见下方 "[本地改动]"
import torch
...
# [本地改动] 原文是相对导入 `from .utils import ut_mask`；这里不在 pykt 包内，改成从已安装的 pykt 导入（函数完全相同）
