#!/usr/bin/env python
# coding=utf-8
# 来源：pykt-team/pykt-toolkit@2fc4d64880956f21155a238d0b0302ac42cb5196 pykt/datasets/atdkt_dataloader.py
# 原样复制，未改动。input_type 里必须有 "questions"，否则 qseqs 为空，ATDKT.forward 里 .long() 会报错
